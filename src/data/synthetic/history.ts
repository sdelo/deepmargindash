...
const addressToHistory: Record<string, SyntheticHistoryItem[]> = {
  [DEFAULT_ADDR]: [
    { kind: "deposit", asset: "USDC", amount: 2500, shares: 2500, timestamp: Date.now() / 1000 - 86400 * 5 },
    { kind: "deposit", asset: "SUI", amount: 1200, shares: 1200, timestamp: Date.now() / 1000 - 86400 * 3 },
    { kind: "withdraw", asset: "USDC", amount: 300, shares: 300, timestamp: Date.now() / 1000 - 86400 * 2 },
  ],
};
